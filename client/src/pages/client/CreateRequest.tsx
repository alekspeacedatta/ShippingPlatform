...
const CreateRequest = () => {
  ...
  const handleChatSubmit = (e : React.FormEvent) => {
    e.preventDefault();
    setSentMessages([...sentMessages, {sentMessage: message, date: new Date() }]);
  }
  ...
  return (
    <>
      ...
      <div className="mx-auto w-full max-w-3xl md:max-w-5xl px-4 sm:px-6 lg:px-8 py-4 sm:py-6 flex justify-center gap-5">
        <div className='mx-auto w-full max-w-3xl md:max-w-5xl px-4 sm:px-6 lg:px-8 py-4 sm:py-6 flex flex-col justify-start gap-5'>
