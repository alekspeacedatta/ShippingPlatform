...
const Dashboard = () => {
  ...
  return (
    <>
      ...
      <main className="p-[8px] min-h-screen bg-[radial-gradient(80%_60%_at_50%_0%,#eef2ff_0%,#ffffff_40%,#ffffff_100%)] dark:bg-[radial-gradient(80%_60%_at_50%_0%,#0b1220_0%,#0a0f1a_40%,#0a0f1a_100%)]">
      ...
      <div className="fixed bottom-5 right-5 z-50">
        ...
        >
          <div className="flex items-center justify-between rounded-t-2xl bg-gray-100 px-3 py-2">
            <span className="text-sm font-semibold">Chat With client</span>
            <button
          ...
          <div id="chat-scroll" className="flex-1 min-h-0 overflow-y-auto px-3 py-2 gap-2">
