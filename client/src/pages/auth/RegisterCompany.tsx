...
const RegisterCompany = () => {
  ...
  return (
    <div className="flex h-[100vh] items-stretch overflow-hidden">
      <div className="flex shrink-0 basis-full items-center justify-center px-6 py-8 md:basis-[760px]">
        <section ref={formRef} className="w-full max-w-lg rounded-3xl bg-white p-7 shadow-2xl ring-1 ring-black/5">
            ...
            <section className="flex max-h-[60vh] flex-col gap-5 overflow-y-auto py-3 pr-2">
              <section className="flex flex-col gap-3 rounded-[8px]">
                ...
                <section className="grid grid-cols-2 gap-4">
                  ...
                  <section className="flex h-[14vh] flex-col gap-[10px]">
                    <label>Regions: </label>
                    <section className="flex h-[14vh] flex-wrap gap-1 overflow-y-auto rounded-[8px] border-[2px] border-[#d0d4ff] bg-white p-2">
                  ...
                  <section className="flex flex-col gap-[10px]">
                    ...
                    <section className="flex flex-wrap gap-1 rounded-[8px] border-[2px] border-[#d0d4ff] bg-white p-2">
                      <label className="flex cursor-pointer select-none items-center">
                        <input type="checkbox" value="RAILWAY" onChange={toggleShippingType} className="peer sr-only" />
                        <span className="peer-checked:(bg-[#aab0ff] text-white) rounded-[28px] border-[2px] border-[#aab0ff] px-3 py-2 text-[14px] text-[#aaaaaa]">
                          Railway
                        </span>
                      </label>
                      ...
                      <label className="flex cursor-pointer select-none items-center">
                        <input type="checkbox" value="ROAD" onChange={toggleShippingType} className="peer sr-only" />
                        <span className="peer-checked:(bg-[#aab0ff] text-white) rounded-[28px] border-[2px] border-[#aab0ff] px-3 py-2 text-[14px] text-[#aaaaaa]">
                          Road
                        </span>
                      </label>
                      ...
                      <label className="flex cursor-pointer select-none items-center">
                        <input type="checkbox" value="AIR" onChange={toggleShippingType} className="peer sr-only" />
                        <span className="peer-checked:(bg-[#aab0ff] text-white) rounded-[28px] border-[2px] border-[#aab0ff] px-3 py-2 text-[14px] text-[#aaaaaa]">
                          Air
                        </span>
                      </label>
                      ...
                      <label className="flex cursor-pointer select-none items-center">
                        <input type="checkbox" value="SEA" onChange={toggleShippingType} className="peer sr-only" />
                        <span className="peer-checked:(bg-[#aab0ff] text-white) rounded-[28px] border-[2px] border-[#aab0ff] px-3 py-2 text-[14px] text-[#aaaaaa]">
                          Sea
                        </span>
                      </label>
                    ...
                    <Input
                      onChange={(e) =>
                        setCompanyInfo({
                          ...
                          pricing: {
                            ...companyInfo.pricing,
                            insurancePct: Number(e.target.value),
                          },
                        })
                      }
                      type="float"
