      ...
      <div className="mx-auto w-full max-w-5xl px-4 sm:px-6 lg:px-8 py-4 sm:py-6 md:py-10 flex flex-col gap-4 sm:gap-6">
        ...
        <div className="grid gap-3 sm:gap-4 rounded border bg-white p-3 sm:p-4 md:p-5 md:grid-cols-3">
          ...
          <section className="flex flex-col gap-2 rounded md:px-4">
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs sm:text-sm">
                <span className="text-gray-500">fragile: </span>{String(parcel.parcel.fragile)},{' '}
                ...
                return (
                  <div key={`${t.at}-${t.status}-${idx}`} className="grid grid-cols-[24px_1fr] gap-3">
                    <div className="relative flex h-full w-6 items-center justify-center">
                      ...
                      <span className={`relative z-10 h-3.5 w-3.5 rounded-full border-2 border-white ${color} shadow`} />
                      {!isLast && (
        ...
        <div className="pt-1 sm:pt-2">
          <h2 className="text-xl sm:text-2xl font-semibold">
            Total price{' '}
            <span className="font-bold text-green-500">{parcel.priceEstimate}$</span>
          </h2>
        </div>
      </div>
    </div>
