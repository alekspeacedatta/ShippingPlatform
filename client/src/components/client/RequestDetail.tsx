    ...
    <>
      ...
      <div className="min-h-screen flex items-center justify-center flex-col">
        ...
        <div className="flex items-center gap-2">
          <p className="cursor-pointer hover:underline hover:underline-offset-4 hover:font-semibold" onClick={() => navigate(-1)}>all requests</p>
          <span>→</span>
          <p className="cursor-pointer underline transition-all duration-200 underline-offset-4 font-semibold text-indigo-500" onClick={() => navigate(1)}>request details</p>
        </div>
